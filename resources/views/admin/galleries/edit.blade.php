...
<body class="bg-linear-to-br from-slate-50 via-white to-blue-50 text-gray-900">
    ...
    <div class="flex">
        ...
        <main class="flex-1 ml-72 p-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-4xl font-bold bg-linear-to-r from-blue-600 via-cyan-600 to-teal-600 bg-clip-text text-transparent">Edit Galeri</h1>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm max-w-2xl">
                <form action="{{ route('admin.galleries.update', $gallery->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <!-- Preview Gambar Lama -->
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Gambar Saat Ini</label>
                        <div class="bg-gray-50 rounded-xl overflow-hidden h-48 border border-gray-200 shadow-sm">
                    ...
                    <!-- Upload Gambar Baru -->
                    <div>
                        <label for="image" class="block text-sm font-semibold text-gray-900 mb-2">Gambar Baru (Opsional)</label>
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 hover:bg-blue-50 transition relative min-h-48 bg-gray-50">
                            <input 
                                ...
                                accept="image/*"
                                class="hidden"
                                onchange="previewGalleryImage(this); document.getElementById('fileName').textContent = this.files[0]?.name || 'Pilih file baru'"
                            />
                            ...
                            <div id="uploadPrompt" class="block">
                                <label for="image" class="cursor-pointer block">
                                    ...
                                    <p class="text-gray-700 font-medium">Klik untuk mengganti gambar atau drag & drop</p>
                                    <p id="fileName" class="text-gray-500 text-sm mt-2">Tidak ada file baru</p>
                                </label>
                            </div>

                            <!-- Image Preview Container -->
                            <div id="galleryImagePreviewEdit" class="hidden flex flex-col items-center justify-center">
                                <img id="galleryPreviewImgEdit" src="" alt="Preview" class="h-40 object-contain rounded-lg">
    ...
    <script>
        function previewGalleryImage(input) {
            const previewContainer = document.getElementById('galleryImagePreviewEdit');
            const uploadPrompt = document.getElementById('uploadPrompt');
            const previewImg = document.getElementById('galleryPreviewImgEdit');
