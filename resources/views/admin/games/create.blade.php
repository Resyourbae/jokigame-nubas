...
<head>
    ...
    <title>Tambah Game - Admin Dashboard</title>
    ...
    <div class="flex">
        ...
        <main class="flex-1 ml-72 p-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-4xl font-bold bg-linear-to-r from-purple-600 via-blue-600 to-cyan-600 bg-clip-text text-transparent">Tambah Game Baru</h1>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm max-w-2xl">
                <form action="{{ route('admin.games.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        />
                        <p class="text-gray-500 text-xs mt-2">Format: JPG, PNG, GIF, WebP | Biarkan kosong jika tidak ingin mengupload foto</p>

                        <!-- Image Preview -->
                        <div id="imagePreview" class="mt-4 hidden">
                            <div class="relative w-fit">
                                <div class="absolute -top-2 left-1/2 -translate-x-1/2 w-32 h-12 bg-green-400 rounded-full blur-2xl opacity-70 animate-pulse"></div>
                                <img id="previewImg" src="" alt="Preview" class="w-32 h-32 object-cover rounded-xl border border-gray-200 shadow-sm relative z-10">
