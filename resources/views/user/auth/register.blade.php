    ...
    <div class="w-full max-w-md px-6 py-8">
        ...
        <div class="bg-slate-800 rounded-lg shadow-2xl p-8 border border-fuchsia-600 border-opacity-30">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <!-- Name -->
                <div>
                    <label for="name" class="block text-gray-300 text-sm font-medium mb-2">Nama Lengkap</label>
                    <input
                        type="text"
                        id="name"
                        name="name"
                ...
                <div>
                    <label for="password_confirmation" class="block text-gray-300 text-sm font-medium mb-2">Konfirmasi Password</label>
                    <input
                        type="password"
            ...
            <p class="text-center text-gray-300 text-sm">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-yellow-400 font-semibold hover:text-yellow-300 transition">
                    Masuk di sini
                </a>
            </p>
        </div>
